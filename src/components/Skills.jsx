  ...
  const skillCategories = [
    {
      ...
      hoverBorder: "hover:border-blue-500/40",import React, { useState, useEffect } from 'react';
import { motion } from 'framer-motion';
import { Code, Database, Wrench, Brain } from 'lucide-react';
  ...
  const skillCategories = [
    {
      ...
      hoverBgColor: "rgba(59, 130, 246, 0.1)",
      skills: [
    ...
    },
    {
      ...
      hoverBgColor: "rgba(34, 197, 94, 0.1)",
      skills: [
    ...
    },
    {
      ...
      hoverBgColor: "rgba(168, 85, 247, 0.1)",
      skills: [
    ...
    },
    {
      ...
      hoverBgColor: "rgba(249, 115, 22, 0.1)",
      skills: [
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8">
          {skillCategories.map((category, categoryIndex) => (
            <motion.div
              ...
              viewport={{ once: true }}
              whileHover={{ 
                backgroundColor: category.hoverBgColor,
                scale: 1.02,
                transition: { duration: 0.3 }
              }}
              className={`${category.bgColor} p-6 rounded-lg border ${category.borderColor} ${category.hoverBorder} transition-all duration-300 hover:shadow-xl`}
            >
